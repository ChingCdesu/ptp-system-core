...
const std::string Course::Cols::_course_name = "course_name";
const std::string Course::Cols::_teacher_id = "teacher_id";
const std::string Course::Cols::_start_time = "start_time";
const std::string Course::Cols::_end_time = "end_time";
const std::string Course::Cols::_student_group = "student_group";
...
const std::string &Course::getValueOfCourseName() const noexcept
{
...
const std::shared_ptr<std::string> &Course::getCourseName() const noexcept
{
    return courseName_;
}
void Course::setCourseName(const std::string &pCourseName) noexcept
{
    courseName_ = std::make_shared<std::string>(pCourseName);
    dirtyFlag_[1] = true;
}
void Course::setCourseName(std::string &&pCourseName) noexcept
{
...
const int32_t &Course::getValueOfTeacherId() const noexcept
{
    const static int32_t defaultValue = int32_t();
    if(teacherId_)
        return *teacherId_;
...
const std::shared_ptr<int32_t> &Course::getTeacherId() const noexcept
{
    return teacherId_;
}
void Course::setTeacherId(const int32_t &pTeacherId) noexcept
{
...
const ::trantor::Date &Course::getValueOfStartTime() const noexcept
{
...
const std::shared_ptr<::trantor::Date> &Course::getStartTime() const noexcept
{
    return startTime_;
}
void Course::setStartTime(const ::trantor::Date &pStartTime) noexcept
{
...
const ::trantor::Date &Course::getValueOfEndTime() const noexcept
{
    const static ::trantor::Date defaultValue = ::trantor::Date();
    if(endTime_)
        return *endTime_;
...
const std::shared_ptr<::trantor::Date> &Course::getEndTime() const noexcept
{
    return endTime_;
}
void Course::setEndTime(const ::trantor::Date &pEndTime) noexcept
{
...
const std::string &Course::getValueOfStudentGroup() const noexcept
{
    const static std::string defaultValue = std::string();
    if(studentGroup_)
...
const std::shared_ptr<std::string> &Course::getStudentGroup() const noexcept
{
    return studentGroup_;
}
void Course::setStudentGroup(const std::string &pStudentGroup) noexcept
{
    studentGroup_ = std::make_shared<std::string>(pStudentGroup);
    dirtyFlag_[5] = true;
}
void Course::setStudentGroup(std::string &&pStudentGroup) noexcept
{
