...
class PtpSubject
{
  public:
     ...
     */
    explicit PtpSubject(const Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit PtpSubject(const Json::Value &pJson) noexcept(false);
     ...
     */
    PtpSubject(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);
    ...
    void setStudentIdToNull() noexcept;
  ...
  private:
    friend Mapper<PtpSubject>;
#ifdef __cpp_impl_coroutine
    friend CoroMapper<PtpSubject>;
#endif
